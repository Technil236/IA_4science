...
# Exercise B (part 2): implement another little grid world here.
...
# Exercise A: Implement "return" computation
def runEpisode(agent, environment, discount, decision, display, message, pause, episode):
  ...
  while True:
    ...
    if len(actions) == 0: # exit is reached.
      # possibly write an informative message such as:
      # message("EPISODE "+str(episode)+" COMPLETE: RETURN WAS "+str(returns)+"\n")
      return 0 # Exercise A: make sure you return the appropriate discounted accumulated reward
    ...
    # Exercise A: make sure you keep track of the rewards received!
...
#  if not opts.textDisplay:
  ...
  # Exercise A: Make sure to calculate the mean and standard deviation of the returns over episodes.
  ...
  if opts.episodes > 0:
    # Exercise A: print out the average and standard deviation of returns
